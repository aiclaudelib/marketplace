...
Community Claude Code plugins by aiclaudelib.

## Quick Install

Add the marketplace and use the interactive installer:

```
/plugin marketplace add aiclaudelib/marketplace
/plugin install aiclaudelib@aiclaudelib
```

Then run `/aiclaudelib:install` to browse and install plugins interactively.
...
Or use the interactive installer to browse and select plugins:
